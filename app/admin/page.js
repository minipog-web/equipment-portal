      ...
      <div className="bento-grid">
        ...
        <div className="double-bezel-outer bento-col-4">
          <div className="double-bezel-inner" style={{ padding: '24px', textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '4px', background: 'var(--accent)', boxShadow: '0 0 10px var(--accent-glow)' }} />
            <div style={{ fontSize: '11px', color: 'var(--text-label)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '600', marginBottom: '8px' }} className="diagnostic-mono">Open Requests</div>
            <div style={{ fontSize: '2.8rem', fontWeight: '700', color: 'var(--accent)', lineHeight: '1.2' }} className="diagnostic-mono">{openRequests.length}</div>
        ...
        <div className="double-bezel-outer bento-col-4">
          <div className="double-bezel-inner" style={{ padding: '24px', textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '4px', background: 'var(--text-label)', boxShadow: '0 0 10px rgba(255,255,255,0.05)' }} />
            <div style={{ fontSize: '11px', color: 'var(--text-label)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '600', marginBottom: '8px' }} className="diagnostic-mono">Resolved</div>
            <div style={{ fontSize: '2.8rem', fontWeight: '700', color: 'var(--text-main)', lineHeight: '1.2' }} className="diagnostic-mono">{completedRequests.length}</div>
        ...
        <div className="double-bezel-outer bento-col-4">
          <div className="double-bezel-inner" style={{ padding: '24px', textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '4px', background: 'var(--accent-secondary)', boxShadow: '0 0 10px rgba(255, 107, 0, 0.2)' }} />
            <div style={{ fontSize: '11px', color: 'var(--text-label)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '600', marginBottom: '8px' }} className="diagnostic-mono">Total Volume</div>
            <div style={{ fontSize: '2.8rem', fontWeight: '700', color: 'var(--accent-secondary)', lineHeight: '1.2' }} className="diagnostic-mono">{requests.length}</div>
        ...
        <div className="double-bezel-outer bento-col-12">
          <div className="double-bezel-inner" style={{ padding: '32px', position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '4px', background: completionRate > 80 ? 'var(--accent)' : 'var(--accent-secondary)', boxShadow: completionRate > 80 ? '0 0 10px var(--accent-glow)' : '0 0 10px rgba(255, 107, 0, 0.2)' }} />
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
              <div>
                <div style={{ fontSize: '11px', color: 'var(--text-label)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '600', marginBottom: '8px' }} className="diagnostic-mono">Completion Rate</div>
                <div style={{ fontSize: '3.2rem', fontWeight: '800', lineHeight: '1', color: completionRate > 80 ? 'var(--accent)' : 'var(--accent-secondary)' }} className="diagnostic-mono">{completionRate}%</div>
              ...
              <div style={{ flex: '1', maxWidth: '400px', minWidth: '240px' }}>
                <div style={{ 
                  ...
                  <div style={{ 
                    ...
                    height: '100%', 
                    background: completionRate > 80 ? 'var(--accent)' : 'var(--accent-secondary)',
                    boxShadow: completionRate > 80 ? '0 0 10px var(--accent-glow)' : '0 0 10px rgba(255, 107, 0, 0.2)',
          ...
          <div className="double-bezel-inner" style={{ padding: 0, overflowX: 'auto' }}>
            ...
            <thead>
              <tr style={{ textAlign: 'left', borderBottom: '1px solid rgba(255, 255, 255, 0.08)', background: 'rgba(255,255,255,0.01)' }}>
                <th style={{ padding: '20px 24px', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', color: 'var(--text-label)', letterSpacing: '0.08em' }} className="diagnostic-mono">Equipment</th>
                <th style={{ padding: '20px 24px', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', color: 'var(--text-label)', letterSpacing: '0.08em' }} className="diagnostic-mono">Requester</th>
                <th style={{ padding: '20px 24px', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', color: 'var(--text-label)', letterSpacing: '0.08em' }} className="diagnostic-mono">Location</th>
                <th style={{ padding: '20px 24px', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', color: 'var(--text-label)', letterSpacing: '0.08em' }} className="diagnostic-mono">Date</th>
                <th style={{ padding: '20px 24px', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', color: 'var(--text-label)', letterSpacing: '0.08em' }} className="diagnostic-mono">Urgency</th>
                <th style={{ padding: '20px 24px', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', color: 'var(--text-label)', letterSpacing: '0.08em' }} className="diagnostic-mono">Status</th>
                <th style={{ padding: '20px 24px', fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', color: 'var(--text-label)', letterSpacing: '0.08em' }} className="diagnostic-mono">Actions</th>
              </tr>
            </thead>
            <tbody>
                ...
                <Fragment key={req.id}>
                  <tr className={req.status === 'Resolved' ? 'completed-row' : ''} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)', transition: 'all 0.2s' }}>
                    <td style={{ padding: '24px' }}>
                      ...
                      <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '2px' }} className="diagnostic-mono">{req.model || 'No model specified'}</div>
                      {req.claimedBy && (
                    ...
                    <td style={{ padding: '24px' }}>
                      <div style={{ fontWeight: '600', color: 'var(--accent)' }} className="diagnostic-mono">{req.name}</div>
                    </td>
                    <td style={{ padding: '24px' }}>
                      <div style={{ fontWeight: '500' }}>{req.location}</div>
                      <div style={{ fontSize: '12px', color: 'var(--text-muted)' }} className="diagnostic-mono">ROOM {req.room}</div>
                    </td>
                    <td style={{ padding: '24px' }}>
                      <div style={{ fontWeight: '500', fontSize: '13px' }} title={getFullDate(req.createdAt)} className="diagnostic-mono">
                        {getTimeOpen(req.createdAt)}
                      </div>
                      {req.status === 'Resolved' && (
                        <div style={{ fontSize: '10px', color: 'var(--text-muted)', marginTop: '4px' }} className="diagnostic-mono">
                    ...
                    <td style={{ padding: '24px' }}>
                      <span style={{ 
                        color: req.urgency === 'High' ? 'var(--accent-red)' : req.urgency === 'Medium' ? 'var(--accent-secondary)' : 'var(--accent)',
                        fontWeight: 'bold',
                        fontSize: '13px'
                      }} className="diagnostic-mono">
                          ...
                          <>
                            ...
                            {!req.claimedBy && (
                              <button 
                                type="button"
                                className="action-button" 
                                style={{ borderColor: 'rgba(0, 255, 102, 0.4)', color: 'var(--accent)' }}
                                onClick={() => {
